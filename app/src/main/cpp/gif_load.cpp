...
Java_com_kalu_gif_GifLoad_loadPath(JNIEnv *env, jobject thiz, jstring path_) {
...
Java_com_kalu_gif_GifLoad_getWidth(JNIEnv *env, jobject thiz, jlong ndk_gif) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_kalu_gif_GifLoad_getHeight(JNIEnv *env, jobject thiz, jlong ndk_gif) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_kalu_gif_GifLoad_updateFrame(JNIEnv *env, jobject thiz, jlong ndk_gif,
                                                jobject bitmap) {
